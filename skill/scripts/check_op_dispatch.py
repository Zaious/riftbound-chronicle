...
FILES = ["effect_ir.py", "resolution_bridge.py", "play_transaction.py", "engine_check.py", "engine_decisions.py", "cost_receipt.py", "combat.py", "battlefield_control.py", "terminal.py", "reward_adapter.py", "randomization_receipt.py", "turn_cycle.py"]
