...
KIND_CONFIG = {
    ...
    "effect": {
        ...
        "supported": ["typed_atomic_effects", "bounded_replacement", "bounded_cleanup", "typed_selectors", "object_identity", "engine_decisions", "battlefield_targets", "criteria_expansion", "bonus_damage", "instruction_conditions", "move_triggers", "private_discard", "granted_replacements", "combat_relative_might", "keyword_modifiers", "active_combat_criteria", "mutual_current_might_damage", "burn_out_draw", "randomization_receipt", "choice_grammar", "modal_abilities", "card_ordering", "look_reveal_put_back", "predict", "multi_recycle", "restricted_resource_grant", "repeat_execution", "banish", "counter", "burn", "attachments", "top_most_might_bonus", "derived_detach_destination", "legend_objects", "legend_zone_passives", "continuous_effects", "layer_engine", "canonical_migration", "typed_conditions"],
        "unsupported": ["arbitrary_card_text", "combat", "scoring", "burn_out_non_draw", "burn_out_in_replacement", "distinct_per_turn_choice", "each_player_choice", "multi_opponent_choice", "revealed_knowledge_persistence", "cannot_be_countered", "burn_triggers", "nested_attachments", "effect_text_append", "gear_recall_cleanup", "copy_characteristics", "champion_legend_movement", "token_not_in_catalogue", "layer_dependency_unresolved", "condition_needs_hidden_information", "complete_game", "complete_legality"],
    },
    "resolution": {
