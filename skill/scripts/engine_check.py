...
KIND_CONFIG = {
    ...
    "effect": {
        ...
        "unsupported": ["arbitrary_card_text", "combat", "scoring", "burn_out_non_draw", "burn_out_in_replacement", "distinct_per_turn_choice", "each_player_choice", "multi_opponent_choice", "revealed_knowledge_persistence", "cannot_be_countered", "burn_triggers", "nested_attachments", "effect_text_append", "gear_recall_cleanup", "copy_characteristics", "champion_legend_movement", "complete_game", "complete_legality"],
    },
    "resolution": {
